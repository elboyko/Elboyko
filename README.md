...
Меня зовут Елена и я Frontend-разработчик. В данный момент ищу возможность присоединиться к команде, где смогу развиваться и внести вклад в создание кода высокого качества.
...
---
### [Киносайт - проект на чистом JS](https://elboyko.github.io/js-project/)
...
Верстка первой страницы для магазина по продаже разных сортов чая с использованием JavaScript
